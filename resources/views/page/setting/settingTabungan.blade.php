                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                            <input name="ctl00$MainContent$tgleffrate" type="text"
                                                value="01-07-2022" id="MainContent_tgleffrate"
                                                class="form-control">
                                            <span class="input-group-btn">
                                                <button id="MainContent_btncal1" class="btn default"
                                                    type="button">
                                ...
                                <table class="table table-light table-striped table-hover table-bordered"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input name="ctl00$MainContent$rate1" type="text"
                                                    value="1.00" id="MainContent_rate1"
                                                    class="aspNetDisabled form-control text-right numeric progresif">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="ctl00$MainContent$rate2" type="text"
                                                    value="3.00" id="MainContent_rate2"
                                                    class="aspNetDisabled form-control text-right numeric progresif">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="ctl00$MainContent$rate3" type="text"
                                                    value="5.00" id="MainContent_rate3"
                                                    class="aspNetDisabled form-control text-right numeric progresif">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="ctl00$MainContent$rate4" type="text"
                                                    value="10.00" id="MainContent_rate4"
                                                    class="aspNetDisabled form-control text-right numeric progresif">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input name="ctl00$MainContent$rate5" type="text"
                                                    value="0" id="MainContent_rate5"
                                                    class="aspNetDisabled form-control text-right numeric progresif">
                                            </td>
                                            <td>
