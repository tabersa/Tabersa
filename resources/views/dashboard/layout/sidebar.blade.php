            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item menu-accordion my-4">
                    ...
                    <a class="menu-link" href="{{ url('/dashboard') }}">
                        ...
                        <span class="menu-title text-light fw-bold">Home</span>
                ...
                <div class="menu-item menu-accordion my-4">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="{{ url('/cif') }}">
                        <span class="menu-icon">
                        ...
                        <span class="menu-title text-light fw-bold">Customer Information Page</span>
                        {{-- <span class="menu-arrow"></span> --}}
                    </a>
                    <!--end:Menu link-->
                ...
                <div class="menu-item menu-accordion my-4">
                    ...
                    <a class="menu-link" href="{{ url('/tabungan') }}">
                        ...
                        <span class="menu-title text-light fw-bold">Tabungan</span>
                        {{-- <span class="menu-arrow"></span> --}}
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item menu-accordion my-4">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="{{ url('/transaksi') }}">
                        <span class="menu-icon">
                        ...
                        <span class="menu-title text-light fw-bold">Transaksi</span>
                        {{-- <span class="menu-arrow"></span> --}}
                    </a>
                    <!--end:Menu link-->
                </div>
                ...
                <div class="menu-item menu-accordion my-4">
                    <!--begin:Menu link-->
                    <a class="menu-link" href="{{ url('/sinkron') }}">
                        <span class="menu-icon">
                        ...
                        <span class="menu-title text-light fw-bold">Synchronization</span>
                        {{-- <span class="menu-arrow"></span> --}}
                    </a>
                    <!--end:Menu link-->
                </div>
